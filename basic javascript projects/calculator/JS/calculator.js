...
const Calculator={ 
    ...
    First_Operand:null,
    //this checks weather or not the second operanf has been inputted by the user. 
...
function Handle_Operator(Next_Operator) {
    ...
    //displayed on the screen to a number and then store the resuly in 
    //Calculator.First_Operand if it doesn't already exist. 
    const Value_of_Input=parseFloat(Display_Value);
    //check if an operator already exists and if Wait_Second_Operad is true,
...
//This function updates the calculator screen with the contents of Dsiplay_Value
function Update_Display() {
    //make use of the calculator-sreen class target the 
    //inputtag in the HTML document
...
//the tartget variable is an object that represents the element
//that was clicked. 
const {target}=event;
