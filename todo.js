...
/*this function keeps the tasks permanately displayed on the screen*/
function show() {
   ...
   html +='<ul>';
   /*thid displays the task as a list*/
   document.getElementById('todos').innerHTML=html;
}
/*this displays the inputed task when the 'Add Item' button is clicked*/
document.getElementById('add').addEventListener('click', add);
/*this will keep the inputs displayed permanataly on the screen*/
show();
